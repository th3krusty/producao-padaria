      ...
      <main className="flex-1 min-w-0 pt-16 md:pt-0">
        <header className={`flex flex-wrap items-center justify-between gap-3 px-4 md:px-6 py-4 border-b ${t.border}`}>
          <div>
            ...
            <p className={`text-xs ${t.textMuted} mt-0.5`}>{page === "oee" ? "visão de todas as linhas" : `linha: ${linhaAtiva}`}</p>
          </div>
          <div className="flex items-end gap-3">
            {page !== "oee" && <div className="w-48"><Layers size={0} />{LinhaSelector}</div>}
